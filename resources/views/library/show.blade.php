...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        @if($book->pdf_file)
        <a href="{{ file_url($book->pdf_file) }}" target="_blank" class="btn btn-danger">
        ...
        <div class="card-sistech">
            ...
            <div class="card-body" style="font-size: 13px;">
                ...
                <div class="d-flex justify-content-between py-2">
                    ...
                    @if($book->pdf_file)
                        <a href="{{ file_url($book->pdf_file) }}" target="_blank" class="text-decoration-none">
    ...
    <div class="col-lg-8">
        ...
        <div class="card-sistech">
            ...
            <div class="card-body p-0">
                <iframe src="{{ file_url($book->pdf_file) }}" style="width: 100%; height: 600px; border: none; border-radius: 0 0 12px 12px;"></iframe>
            </div>
        </div>
        @else
        <div class="card-sistech">
